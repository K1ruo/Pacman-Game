...
class PacMan:
    def __init__(self):
        self.trollIcon = pygame.image.load('Trollman.png')
        ...
        self.pacman = Player(self.w, self.p_h, "Trollman.png")
        self.all_sprites_list.add(self.pacman)
        self.pacman_collide.add(self.pacman)

        self.blinky = Ghost(self.w, self.b_h, "Blinky.png", pacman_utils.blinky_directions, False)
        self.monster_list.add(self.blinky)
        self.all_sprites_list.add(self.blinky)

        self.pinky = Ghost(self.w, self.m_h, "Pinky.png", pacman_utils.pinky_directions, False)
